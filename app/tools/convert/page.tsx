  ...
  return (
    <div className="flex flex-col gap-12 animate-fade-in">
      <div className="flex flex-col gap-6">
        ...
        <h2 className="text-3xl md:text-4xl font-medium tracking-tight text-accent">Format Converter</h2>
      </div>

      {!file ? (
        <ImageDropzone onFileSelect={setFile} label="Select image to convert" />
      ) : (
          ...
          <div className="lg:col-span-4 flex flex-col gap-8">
            ...
            {result && (
              <div className="flex flex-col gap-6 bg-surface border border-border p-6 rounded-sm animate-fade-in">
                ...
                <a
                  href={result.url}
                  download={`alan-${file.name.split('.')[0]}.${outFormat.split('/')[1]}`}
